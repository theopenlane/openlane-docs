...
:::info
This integration is not currently visible in the Integrations page. [GitHub App](../github_app/overview) is the recommended path for connecting GitHub repositories to Openlane.
:::

# GitHub Integration Guide ![github integration](../assets/github.png)
