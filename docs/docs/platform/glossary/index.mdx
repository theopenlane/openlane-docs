...
The American Institute for Certified Public Accountants (AICPA) is the governing body that establishes the standards, criteria, and guidance for all SOC 2 Audits. All official SOC 2 reports must be issued by a licensed CPA firm that is accredited by the AICPA.
