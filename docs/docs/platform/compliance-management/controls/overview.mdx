...
graph TD
    ...
    style B fill:#e1f5fe,stroke:#039be5,color:#333
    style A fill:#f3e5f5,stroke:#8e24aa,color:#333
    style F fill:#ffebee,stroke:#e53935,color:#333
    style G fill:#e8f5e8,stroke:#43a047,color:#333
```
