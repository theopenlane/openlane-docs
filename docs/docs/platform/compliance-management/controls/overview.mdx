...
<Tabs className="unique-tabs">
  <TabItem value="Detective" label="Detective">
    Detective controls alert employees to an action that has occurred.
    <br/>
  ...
  <TabItem value="Preventative" label="Preventative">
    Preventative controls help prevent certain events from occurring.<br/>
    <br/>
  ...
  <TabItem value="Corrective" label="Corrective">
    Corrective controls take action based upon an event that occurred.<br/>
    <br/>
    **Example**: The DevOps team developed a script to spin up in a new region if their current region goes down
    ...
    Compensating controls are used when a process or technology is deficient and would require enormous changes, or it would be very costly for the organization to remediate. Oftentimes compensating controls are used more to assist information systems and IT processes, rather than business processes.
  </TabItem>
</Tabs>
...
Policies set the direction: they define the overall goals and expectations for managing risks, acting as the foundation for creating controls. Controls are the active measures: the actual mechanisms or processes used to manage risks, including things like approvals, verifications, monitoring systems, and security protocols. Procedures provide the steps, outlining the specific actions employees need to take to follow the policies and implement the controls effectively.
...
| Needs approval | Ready for management review | Review requirements, approve or request changes |
| Changes requested | Requires modifications before approval | Address feedback, resubmit for approval |
| Approved | Approved and ready for implementation | Begin implementation, collect evidence |
| Not implemented | Approved but not yet active | Complete implementation activities |
| Archived | No longer active or relevant | Document reason for archival |

---

*For programmatic access, see the [Controls GraphQL examples](../../../developers/graphql-examples/controls.mdx) in the developer docs.*
