...
<head>
  <meta name="keywords" content="compliance automation, GRC platform, security compliance, regulatory compliance, SOC 2, ISO 27001, open source compliance" />
  <meta name="twitter:card" content="summary_large_image" />
  <meta property="og:title" content="Openlane Platform Overview - Compliance Automation & Security" />
  <meta property="og:description" content="Open-source compliance automation platform for managing security, risk, and regulatory requirements across multiple frameworks and standards" />
  <meta property="og:type" content="website" />
  <link rel="canonical" href="https://docs.theopenlane.io/docs/platform/overview" />
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      description: 'Open-source compliance automation platform for managing security, risk, and regulatory requirements',
      operatingSystem: 'Web',
      offers: {
        '@type': 'Offer',
        price: '0',
