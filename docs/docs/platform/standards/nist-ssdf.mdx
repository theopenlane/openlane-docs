...
The [Secure Software Development Framework (SSDF)](https://csrc.nist.gov/projects/ssdf) is a set of guidelines for secure software development. It was created by the National Institute of Standards and Technology (NIST) in response to [President Biden's Executive Order on improving the nation's cybersecurity](https://www.nist.gov/itl/executive-order-14028-improving-nations-cybersecurity). Federal software suppliers attest to its practices through the CISA self-attestation form covered below.
