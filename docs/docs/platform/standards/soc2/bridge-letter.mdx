...
Your SOC 2 is only valid for a year after your audit. If you’re behind on renewing your SOC 2 report and it falls past the date in which it’s valid, you may need a SOC 2 bridge letter. The letter maintains trust with your customers while you renew the report.
...
A late renewal isn't the only trigger. Because Type 2 reporting periods rarely line up with every customer's fiscal year, a customer whose fiscal year ends after your report period may ask for a bridge letter covering the months between your period end date and their year-end, even when your next audit is on schedule.
