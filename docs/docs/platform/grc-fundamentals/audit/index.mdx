...
1. [Define the audit scope](./scoping.mdx): what services, systems, and Trust Services Categories the audit covers, and which subservice organizations are in or out.
1. [Identify key stakeholders](./stakeholders.mdx): who owns control design, evidence collection, policies, and the system description.
