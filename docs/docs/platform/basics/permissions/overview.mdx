...
- Create tasks, comments, and evidence uploads
...
See [Groups and Permissions](../groups/permissions.mdx) for detailed guidance.
...
This cannot currently be done via the UI, however, the API supports this functionality. Refer to the [GraphQL examples](../permissions/graphql.mdx) for more information.