...
### Delete Trust Center
```graphql
mutation DeleteTrustCenter($id: ID!) {
  deleteTrustCenter(id: $id) {
    deletedID
  }
}
```
...
### Access Control
- **Anonymous Access**: Support for public trust centers without authentication
- **Role-Based Access**: Granular permissions for trust center management
- **Organization Boundaries**: Trust centers are scoped to specific organizations
- **Content Filtering**: Automatic filtering of sensitive information for public display

### Data Protection
- **Information Classification**: Careful classification of information for public disclosure
- **PII Protection**: Automatic redaction of personally identifiable information
- **Sensitive Data**: Restricted access to sensitive security information
- **Data Retention**: Compliance with data retention policies for trust center content

### Audit and Monitoring
- **Access Logging**: Complete audit trail of trust center access
- **Content Changes**: Version control and audit trail for content modifications
- **Usage Analytics**: Monitoring of trust center usage patterns
- **Compliance Reporting**: Reports on trust center effectiveness and usage
...
### Custom Domains
```javascript
// Configure custom domain for trust center via GraphQL
...
Trust Centers integrate with several other Openlane objects:

### Direct Relationships
- **Organization**: Trust centers belong to organizations
- **Custom Domain**: Trust centers can have custom domains
- **Trust Center Settings**: Configuration and appearance settings
- **Trust Center Subprocessors**: Third-party vendor information

### Indirect Relationships
- **Standards**: Trust centers display compliance with various standards
- **Controls**: Trust centers may reference implemented controls
- **Evidence**: Trust centers can link to compliance evidence
- **Policies**: Trust centers often reference organizational policies
