...
The fastest way to understand the platform is to build something real, so this guide walks you through the first few steps to get your environment set up and your compliance program taking shape.
...
[Full guide](https://docs.theopenlane.io/docs/platform/compliance-management/onboarding/policies)
