...
Every stage of the risk lifecycle has working material here: techniques for identifying risks, how to structure business and technical risk assessments, quantitative and qualitative assessment methods, criteria for choosing a treatment, and approaches to monitoring and communicating risk, with worked examples you can adapt to your own register. Risk assessments are also a standard part of [audit preparation](../../grc-fundamentals/audit/index.mdx), where they complement the [gap analysis](../../grc-fundamentals/audit/gapanalysis.mdx) by surfacing threats the framework requirements alone will not.
