...
- **Configuration Management** - Auto-generated configuration files, secret management, and deployment automation
- **Domain Inheritance System** - Global domain configuration for compliance environments
- **Buildkite Automation** - Automated compliance configuration deployment

### Database Schemas
- **Ent Schemas** - Database entity definitions for all compliance objects
- **Schema Generator** - Automated schema and configuration generation

### API Implementation
- **GraphQL API** - Complete GraphQL schema and resolvers
- **HTTP Handlers** - REST endpoints and authentication

## Compliance Object Categories

### Core Compliance Management
- **[Standards](../docs/platform/standards/overview.mdx)** - Compliance frameworks (SOC 2, ISO 27001, NIST)
- **[Controls](../docs/platform/controls/overview.mdx)** - Specific compliance controls and requirements
- **[Evidence](../docs/platform/programs/evidence/overview.mdx)** - Audit evidence collection and management
- **[Risks](../docs/platform/risks/overview.mdx)** - Risk identification and mitigation

### Program Management
- **[Programs](../docs/platform/programs/overview.mdx)** - Compliance program organization
- **[Control Objectives](../docs/platform/controls/overview.mdx)** - High-level control objectives
- **[Control Implementations](../docs/platform/controls/implementations.mdx)** - Implementation tracking

### Governance and Documentation
- **[Internal Policies](../docs/platform/policies/overview.mdx)** - Policy management
- **[Procedures](../docs/platform/policies/overview.mdx)** - Operational procedures
- **[Narratives](../docs/platform/programs/narratives/overview.mdx)** - Compliance narratives
