...
- **`FilterExpr`**: a CEL expression evaluated against each envelope before ingest, allowing users to ingest only relevant data; see [CEL Expressions](./basics.mdx#cel-expressions)
