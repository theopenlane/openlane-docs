...
This guide walks through how to build a new integration. A companion page covers what's additionally required for [Directory Sync integrations](./building-a-directory-sync-integration.mdx).
