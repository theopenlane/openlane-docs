...
**HookDeletePermissions**: fires on every delete operation and removes all fine-grained authorization (FGA) tuples where the deleted entity is the object. This prevents orphaned authorization relationships.
