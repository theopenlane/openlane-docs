...
<Tabs>
    ...
    <TabItem value="schema">
        This includes all schemas for the database. When generating a new schema, refer to the [GraphQL and codegen](./graphql-and-codegen.mdx) documentation.
...
<Tabs>
    ...
    <TabItem value="query">
        The `internal/graphapi/query/simple` directory contains queries and mutations used to generate the `openlaneclient` using [gqlgenc](https://github.com/Yamashou/gqlgenc)
