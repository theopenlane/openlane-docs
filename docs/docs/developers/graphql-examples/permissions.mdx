...
keywords:
  ...
  - GraphQL queries
---
# Permissions GraphQL Examples

These examples show how to manage authorization through the GraphQL API, including granting object-creation rights to groups and assigning members to programs.
...
Using the `updateOrganization` mutation, you can add a group as a creator for a given object type. In this example, we are adding a group as an internal policy creator for the organization. This will allow any member of the group to create policies within the organization.
