...
# Evidence GraphQL Examples

These examples show how to query, search, filter, create, and update evidence through the GraphQL API, including evidence with file uploads. Copy them as a starting point for your own queries.
