...
|--------|---------|---------------|
| **[Standards](docs/platform/compliance-management/standards/overview.mdx)** | Compliance frameworks and regulations | SOC 2, ISO 27001, NIST, PCI DSS |
| **[Controls](docs/platform/compliance-management/controls/overview.mdx)** | Specific compliance requirements | Access controls, encryption, monitoring |
| **[Evidence](docs/platform/compliance-management/evidence/overview.mdx)** | Audit evidence and documentation | Policies, logs, assessments, reports |
| **[Risks](docs/platform/compliance-management/risk-management/overview.mdx)** | Risk identification and management | Security risks, compliance gaps, business continuity |

### 📋 Program Management
| Object | Purpose | Key Use Cases |
|--------|---------|---------------|
| **[Programs](docs/platform/compliance-management/programs/overview.mdx)** | Compliance program organization | SOC 2 audit, ISO certification, annual reviews |
| **[Control Objectives](docs/platform/compliance-management/controls/overview.mdx)** | High-level control outcomes | Framework alignment, audit preparation |
| **[Control Implementations](docs/platform/compliance-management/controls/implementations.mdx)** | Implementation tracking | Testing schedules, verification records |
| **[Subcontrols](docs/platform/compliance-management/controls/subcontrols.mdx)** | Granular control requirements | Detailed testing, specific procedures |

### 📚 Governance & Documentation
| Object | Purpose | Key Use Cases |
|--------|---------|---------------|
| **[Internal Policies](docs/platform/compliance-management/policy-and-procedure-management/policies.mdx)** | Organizational policies | Security policies, privacy policies, operational procedures |
| **[Procedures](docs/platform/compliance-management/policy-and-procedure-management/policies.mdx)** | Operational procedures | Incident response, change management, access provisioning |
| **Narratives** | Compliance narratives | System descriptions, control descriptions, process flows |

### ⚡ Workflow & Collaboration
| Object | Purpose | Key Use Cases |
|--------|---------|---------------|
| **[Tasks](docs/platform/basics/tasks/overview.mdx)** | Work items and assignments | Evidence collection, control testing, remediation |
...
| **[Entities](docs/platform/basics/entities/overview.mdx)** | Business entities | Subsidiaries, departments, service providers |
...
| **[Files](docs/platform/basics/files/overview.mdx)** | Document management | Evidence files, policy documents, assessment reports |
...
### Quick Start Guide
1. **[Platform Overview](docs/platform/overview.mdx)** - Understand Openlane's compliance capabilities
2. **Authentication** - Set up API authentication
3. **[Create Organization](docs/platform/basics/organizations/overview.mdx)** - Set up your compliance organization
4. **[Import Standards](docs/platform/compliance-management/standards/overview.mdx)** - Load compliance frameworks
5. **[Create Program](docs/platform/compliance-management/programs/overview.mdx)** - Start your first compliance program
