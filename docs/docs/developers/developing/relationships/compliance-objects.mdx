...
| **[Risks](docs/platform/risk-management/overview.mdx)** | Risk identification and management | Security risks, compliance gaps, business continuity |
...
| Object | Purpose | Key Use Cases |
|--------|---------|---------------|
| **[Internal Policies](docs/platform/policy-and-procedure-management/policies.mdx)** | Organizational policies | Security policies, privacy policies, operational procedures |
| **[Procedures](docs/platform/policy-and-procedure-management/policies.mdx)** | Operational procedures | Incident response, change management, access provisioning |
