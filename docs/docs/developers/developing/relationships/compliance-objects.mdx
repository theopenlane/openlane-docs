...
|--------|---------|---------------|
| **[Standards](docs/platform/standards/overview.mdx)** | Compliance frameworks and regulations | SOC 2, ISO 27001, NIST, PCI DSS |
...
4. **[Import Standards](docs/platform/standards/overview.mdx)** - Load compliance frameworks
