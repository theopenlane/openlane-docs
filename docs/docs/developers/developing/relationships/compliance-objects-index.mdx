...
| Object | Purpose | Key Use Cases |
|--------|---------|---------------|
| **[Internal Policies](docs/platform/policy-and-procedure-management/policies/overview.mdx)** | Organizational policies | Security policies, privacy policies, operational procedures |
| **[Procedures](docs/platform/policy-and-procedure-management/policies/overview.mdx)** | Operational procedures | Incident response, change management, access provisioning |
