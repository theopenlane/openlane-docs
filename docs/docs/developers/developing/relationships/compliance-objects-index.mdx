...
| **[Evidence](docs/platform/compliance-management/evidence/overview)** | Audit evidence and documentation | Policies, logs, assessments, reports |
...
| Object | Purpose | Key Use Cases |
|--------|---------|---------------|
| **[Internal Policies](docs/platform/policy-and-procedure-management/overviewx)** | Organizational policies | Security policies, privacy policies, operational procedures |
| **[Procedures](docs/platform/policy-and-procedure-management/overviewx)** | Operational procedures | Incident response, change management, access provisioning |
