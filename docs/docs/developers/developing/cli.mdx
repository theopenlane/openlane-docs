...
:::info
Oauth login is not currently supported using the cli. You must use an [API or Personal Access Token](../security/authentication/api-tokens/overview.mdx) instead.
:::
