...
|**server**|`object`|Server settings for the echo server<br/>|yes|
|**entconfig**|`object`|Config holds the configuration for the ent server<br/>||
|**auth**|`object`|Auth settings including oauth2 providers and token configuration<br/>|yes|
|**authz**|`object`||yes|
|**db**|`object`||yes|
|**jobqueue**|`object`|||
|**redis**|`object`|||
|**sessions**|`object`|||
|**totp**|`object`|||
|**ratelimit**|`object`|Config defines the configuration settings for the rate limiter middleware.<br/>||
|**ratelimitunmatched**|`object`|Config defines the configuration settings for the rate limiter middleware.<br/>||
|**objectstorage**|`object`|ProviderConfig contains configuration for object storage providers<br/>||
|**subscription**|`object`|||
|**keywatcher**|`object`|KeyWatcher contains settings for the key watcher that manages JWT signing keys<br/>||
|**integrations**|`object`|||
|**workflows**|`object`|||
|**cloudflare**|`object`|CloudflareConfig contains configuration for Cloudflare integration.<br/>||
|**shortlinks**|`object`|||
...
|Name|Type|Description|Required|
|----|----|-----------|--------|
|**s3**|`object`|ProviderConfigs contains configuration for all storage providers<br/>||
|**r2**|`object`|ProviderConfigs contains configuration for all storage providers<br/>||
