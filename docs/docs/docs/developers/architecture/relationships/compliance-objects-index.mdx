...
| **[Narratives](../../../platform/programs/narratives/overview.mdx)** | Compliance narratives | System descriptions, control descriptions, process flows |

### ⚡ Workflow & Collaboration
| Object | Purpose | Key Use Cases |
|--------|---------|---------------|
| **[Tasks](../../../platform/tasks/overview.mdx)** | Work items and assignments | Evidence collection, control testing, remediation |
| **[Action Plans](../../../platform/programs/actionplans/overview.mdx)** | Remediation plans | Gap remediation, risk mitigation, improvement projects |
| **Notes** | Comments and collaboration | Review comments, discussion threads, clarifications |

### 🗄️ Asset & Entity Management
| Object | Purpose | Key Use Cases |
|--------|---------|---------------|
| **[Assets](../../../platform/assets/overview.mdx)** | IT assets and infrastructure | Server inventory, application catalog, network devices |
...
2. **[Authentication](../../../platform/security/overview.mdx)** - Set up API authentication
