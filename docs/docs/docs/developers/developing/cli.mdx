...
:::info
Oauth login is not currently supported using the cli. You must use an [API or Personal Access Token](/docs/docs/platform/security/authentication/developer-tokens) instead.
:::
